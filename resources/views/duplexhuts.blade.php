...
<div class="container my-5" style="max-width: 700px;">
  ...
  <div id="treeHouseCarousel" class="carousel slide mb-4" data-bs-ride="carousel">
    <div class="carousel-inner rounded-3 shadow-sm">
      <div class="carousel-item active">
        <img src="{{ asset('images/yj5.jpg') }}" class="d-block w-100" alt="House 1" style="height: 400px; object-fit: cover;">
      </div>
      <div class="carousel-item">
        <img src="{{ asset('images/rooms2.jpg') }}" class="d-block w-100" alt="House 2" style="height: 400px; object-fit: cover;">
      </div>
      <div class="carousel-item">
        <img src="{{ asset('images/yj7.jpg') }}" class="d-block w-100" alt="House 3" style="height: 400px; object-fit: cover;">
      </div>
    </div>
  ...
  <div style="background: #f8f9fa; padding: 20px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); font-family: 'Segoe UI', sans-serif; color: #333;">
    <h3 class="mb-3" style="font-family: 'Gilda Display', serif;">Yonjee Duplex Huts</h3>
